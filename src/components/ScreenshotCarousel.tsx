            ...
            <CarouselItem key={slide.id}>
              <div className="grid md:grid-cols-2 gap-12 items-start p-8">
                ...
                <div className="flex justify-center items-center">
                  <div className="relative w-full max-w-md">
                    <img
                      src={slide.image}
                      alt={slide.title}
                      className="w-full h-auto rounded-2xl shadow-[0_0_60px_rgba(168,85,247,0.3)]"
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col justify-start pt-0 md:pt-4">
                  <h3 className="text-4xl md:text-5xl font-black mb-6 leading-tight bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(168,85,247,0.5)]">
                    {slide.title}
                  </h3>
